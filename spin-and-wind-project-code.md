...
export default function App() {
  ...
  const [options, setOptions] = useState([
    { id: 1, text: 'Beatriz', probability: 10 },
    { id: 2, text: 'Ali', probability: 20 },
    { id: 3, text: 'Hanna', probability: 15 },
    { id: 4, text: 'Gabriel', probability: 25 },
    { id: 5, text: 'Fatima', probability: 10 },
    { id: 6, text: 'Eric', probability: 20 },
  ]);
